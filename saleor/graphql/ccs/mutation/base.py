...
from ...ccs.i18n import I18nMixin
...
class PasswordChange(BaseMutation):
    user = graphene.Field(UserType, description="A user instance with a new password.")
...
#
#     user = graphene.Field(
#         UserType, description="A user object for which the address was edited."
#     )
#
#     class Arguments:
